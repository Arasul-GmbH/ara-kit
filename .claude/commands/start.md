...
Lies zuerst `.ara/persona/ara.md`, dann `.ara/knowledge/onboarding.md` und arbeite das
Verfahren dort ab.
...
Existiert `business/profile.md` bereits, ist das Onboarding gelaufen. Sag dann in drei Zeilen,
