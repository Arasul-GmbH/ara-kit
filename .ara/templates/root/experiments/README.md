...
```
# NNN <the thesis in one sentence>

Status: planned | running | evaluated
Assumption: <number out of company/assumptions.md>
Created: YYYY-MM-DD · Due: YYYY-MM-DD

## Thesis
## What the mistake costs, what the test costs
## The test
## Criterion: confirmed by, refuted by
## Log
## Result
## Decision
```
