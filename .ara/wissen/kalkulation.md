...
| Stundensatz, Aufschlag, Zahlungsziel | `mein/firma.md` |
| Was dieser Kunde braucht | `kunden/<k>/kunde.md` |

Fehlen die Angaben in `mein/firma.md`, frag **einmal** danach und trag sie ein. Beim nächsten
Mal stehen sie da. Frag nicht bei jeder Kalkulation neu.
...
3. **Einrichtung.** Stunden mal Satz. Sei ehrlich: eine Ersteinrichtung an einem Gerätetyp,
