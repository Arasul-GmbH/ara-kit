...
Trag offene Punkte in den Laufzettel und in `abnahme.md` ein. Ein Kunde, der von einem
offenen Punkt weiß, ist ein zufriedener Kunde. Einer, der ihn ein halbes Jahr später
entdeckt, nicht.

## Die Abnahmedatei

`abnahme.md` entsteht **aus dem Laufzettel**, nicht aus der Erinnerung. Sie hält fest, was
