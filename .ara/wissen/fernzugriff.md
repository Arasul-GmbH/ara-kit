...
`node .ara/werkzeuge/geraet-finden.mjs --host <adresse>`
...
Bei der Abnahme wird der Schalter **gezeigt**, nicht erwähnt, und in `abnahme.md`
...
1. Antwortet die Adresse überhaupt? (`geraet-finden.mjs`)
