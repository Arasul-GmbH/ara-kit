...
- **Private SSH-Schlüssel** liegen in `~/.ssh` und bleiben dort. Kopiere sie niemals ins
  ...
  Schlüssel heißt.
- **Kundenpasswörter** gehören in die `.env`, nicht in `geraet.md`. In der Geräteakte steht
...
(`.ara/werkzeuge/riegel.mjs`) blockiert, bevor du sie ausführen kannst — etwa rekursives
