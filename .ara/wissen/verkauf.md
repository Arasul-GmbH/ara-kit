...
3. **Was es kostet.** Einmalig und laufend getrennt (`.ara/wissen/kalkulation.md`).
...
Zieh die Firmendaten aus `mein/firma.md` und den Ton aus dem, was der Partner dort über
