...
Ein lokaler Zwischenspeicher des aktuellen Produktstands unter `.ara/spiegel/`.

```
node .ara/werkzeuge/spiegel.mjs          # holen, wenn nötig
node .ara/werkzeuge/spiegel.mjs --status # nur nachsehen, wie alt er ist
node .ara/werkzeuge/spiegel.mjs --neu    # erzwingen
```
...
| Welcher Stand ist das? | `.ara/spiegel/STAND.json` |
