...
Bevor du etwas am Gerät tust: `node .ara/werkzeuge/fern.mjs --kunde <k> --pruefen`.
...
Verfahren in `.ara/wissen/diagnose.md`. Erst feststellen, dann ändern.
...
4. **Danach die Nachweise aus `.ara/wissen/abnahme.md`** — mindestens: Dienste gesund,
...
Jeder Einsatz erzeugt einen Eintrag unter `kunden/<k>/verlauf/JJJJ-MM-TT-thema.md`
(Vorlage: `.ara/vorlagen/verlauf-eintrag.md`). Das ist die Nachweisführung, wenn ein Kunde
