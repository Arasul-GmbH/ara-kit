...
<pfad zu opencloudcmd>`, und danach lebt sie dort: jeder Aktive am Gerät bekommt sie mit dem
nächsten `sync` oben in seinen eigenen Baum, Administratoren schreiben sie. Der Befehl fragt nach
dem Passwort des Geräts, also führt der Mensch ihn selbst aus; du nennst ihn, mit dem Pfad des
Klienten, und sagst, was passiert: zuerst das Prüfskript, und ein Befund hält an; die Wurzel des
Geräts als Administrator angelegt, nur wenn das Gerät keine führt; nichts von diesem Rechner geht mit; ein Herunterladen
