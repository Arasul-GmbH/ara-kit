...
> Wert davon wird aus dem Gedächtnis geschrieben. Fehlt einer, wird er dort
> nachgetragen und hier nicht erfunden.
>
> **Diese Vorlage füllst du nicht von Hand.** Sie ist das Gerüst, aus dem
...
> Summen. Von Hand bleibt, was nur du weißt, und das steht danach als
> Platzhalter drin.
>
> **Die Pflichtangaben nach § 14 UStG stehen unten als Prüfliste.** Sie wird
> vor dem Druck geprüft: `node .ara/tools/invoice.mjs --check <beleg.md>`.
> Fehlt eine Angabe, wird nicht gedruckt. Eine unvollständige Rechnung
> berechtigt den Kunden nicht zum Vorsteuerabzug, und das fällt bei ihm auf.
>
...
Geprüft wird das mit: node .ara/tools/invoice.mjs --check <beleg.md>

- [ ] Nr. 1: vollständiger Name und vollständige Anschrift des leistenden
      Unternehmers, aus business/company.md
- [ ] Nr. 1: vollständiger Name und vollständige Anschrift des
      Leistungsempfängers, aus der Kundenakte
...
- [ ] Nr. 5: Menge und Art der gelieferten Gegenstände oder Umfang und Art der
      Leistung. "Beratung" allein genügt nicht, es muss hervorgehen, was
      geleistet wurde
- [ ] Nr. 6: Zeitpunkt der Lieferung oder Leistung. Nicht dasselbe wie das
      Rechnungsdatum, auch wenn beides oft auf denselben Tag fällt
- [ ] Nr. 7: das Entgelt, aufgeschlüsselt nach Steuersätzen, und im Voraus
