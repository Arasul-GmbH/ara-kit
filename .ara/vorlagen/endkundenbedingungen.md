...
# Bedingungen für die Nutzung von Arasul

zwischen

**{Partnerfirma}** (nachfolgend "Anbieter")

und

**{Endkunde}**, {Rechtsform}, {Straße}, {PLZ Ort} (nachfolgend "Kunde")

Diese Bedingungen gelten für die Software Arasul, die der Anbieter dem Kunden
überlässt und bei ihm einrichtet. Hersteller der Software ist Arasul, Inhaber
Kolja Schöpe, Seitenstraße 1, 01097 Dresden.

Anlage zu diesen Bedingungen ist die "Leistungsbeschreibung" in der bei
Vertragsschluss geltenden Fassung. Der Kunde bestätigt, sie vor Vertragsschluss
erhalten zu haben.

## 1 Gegenstand

Der Kunde erhält das nicht ausschließliche, zeitlich unbefristete Recht, die
Software auf dem gelieferten Gerät für eigene betriebliche Zwecke zu nutzen. Die
Lizenz ist an das Gerät gebunden.

Der Kunde ist nicht berechtigt, die Software zu vervielfältigen, außer zur
Sicherung, sie zu vermieten, an Dritte zu überlassen, zu dekompilieren (§ 69e UrhG
bleibt unberührt), Schutzvermerke zu entfernen oder Lizenzmechanismen zu umgehen.

## 2 Wer wofür einsteht

Vertragspartner des Kunden ist allein der Anbieter. Der Anbieter schuldet
...
Das System läuft auf Hardware des Kunden in dessen Netz. Der Betrieb einschließlich
Stromversorgung, Netzanbindung, physischer Sicherung und Zutrittskontrolle liegt
allein beim Kunden. **Eine Verfügbarkeit wird nicht geschuldet und nicht
zugesagt.**

Der Kunde ist für die regelmäßige Sicherung seiner Daten verantwortlich. Er prüft
das Sicherungsprotokoll wöchentlich und meldet Fehlschläge unverzüglich. Die im
Produkt enthaltene Sicherungsfunktion entbindet ihn davon nicht.
...
hinausgehen, und zwar unabhängig vom Rechtsgrund. Ansprüche nach Absatz 1 bleiben
...
Der Kunde betreibt das System eigenverantwortlich auf eigener Hardware. Weder
Anbieter noch Hersteller sind insoweit Verantwortliche oder Auftragsverarbeiter.

Für Fernwartungs-, Fehlersuch- und Supportzugriffe, die der Kunde im Einzelfall
anfordert, schließt er mit der zugreifenden Stelle eine Vereinbarung zur
...
Sollte eine Bestimmung dieser Bedingungen unwirksam oder undurchführbar sein oder
