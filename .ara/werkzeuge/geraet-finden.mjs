 ...
 * es probiert.
 *
 *   node .ara/werkzeuge/geraet-finden.mjs --host 192.168.10.44
 *   node .ara/werkzeuge/geraet-finden.mjs --host arasul.local --ports 22,2222,443
 *   node .ara/werkzeuge/geraet-finden.mjs --nachbarn
 */

import { spawnSync } from "node:child_process";
import { lookup } from "node:dns/promises";
import { connect } from "node:net";
import { argumente } from "./lib/kit.mjs";
...
if (typeof arg.host !== "string") {
  console.log(
    [
      ...
      "  --nachbarn                   zeigt die Nachbarschaftstabelle dieses Rechners",
    ].join("\n")
  );
  process.exit(0);
}
...
if (!adresse && !erreichbar && !offen.length) {
  zeilen.push(
    ...
    "Probier die Adresse statt des Namens, und schau mit --nachbarn, was überhaupt antwortet."
  );
